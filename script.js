const profile = {
  ...
  availability: "HR Internship / Data Analysis / Product Operations",
  location: "Open to HR, data analysis, and product operations internships",
  email: "",
  tagline:
    "I use mathematical intuition to read hidden structure in data, and turn AI-assisted code and messy information into explainable analysis.",
  bio:
    "I am looking for HR, data analysis, and product operations internships. My strongest signal is not only using tools, but understanding the math, assumptions, and data signals behind the output.",
  contact:
    "Open to HR, data analysis, and product operations roles. Chinese, English, and daily Japanese communication available.",
  links: [
...
const zhProfile = {
  ...profile,
  title: "个人技术博客名片",
  availability: "HR 实习 / 数据分析 / 产品运营",
  location: "实习地点开放",
  tagline: "我擅长用数学直觉理解数据背后的信息，也能读懂 AI 生成的代码，把非结构化问题整理成可解释的分析结果。",
  bio: "我正在寻找 HR、数据分析和产品运营相关实习机会。我的核心优势不是单纯使用工具，而是理解输出背后的数学假设、数据结构和信息信号。",
  contact: "希望从 HR、数据分析或产品运营类实习做起，可中英沟通，日语可日常口语沟通。",
  links: [
    { label: "GitHub", href: "https://github.com/sudoun" }
  ]
};
...
const uiText = {
  en: {
    htmlLang: "en",
    metaDescription: "Dale Anfer's personal technical blog card focused on mathematical intuition, data sense, AI-assisted code understanding, and public data-analysis writing.",
    ...
    writingToolsLabel: "Published writing status",
    ...
    fitPanelTitle: "Intern candidate for HR, data analysis, and product operations",
    fitTargetLabel: "Target roles",
    fitTargetValue: "HR internship, data analysis, product operations internships",
    fitEvidenceLabel: "Evidence",
    fitEvidenceValue: "Mathematical understanding, data intuition, AI-assisted code reading, explainable analysis",
    fitGithubLabel: "GitHub",
    fitGithubValue: "github.com/sudoun",
    workEyebrow: "Public writing",
    workTitle: "Writing that shows how I think",
    ...
    flowKicker: "Workflow",
    flowTitle: "How I Turn Information Into Analysis",
    ...
    proofTitle: "What I Want The Homepage To Prove",
    ...
    proofDecisionText: "I can turn messy job or operations information into a structure that supports comparison and decision-making.",
    snapshotRole: "Math intuition",
    snapshotRoleValue: "Break problems into variables, constraints, assumptions, and explainable conclusions",
    snapshotTools: "Data sense",
    snapshotToolsValue: "Read structure, anomalies, definitions, and hidden signals behind data",
    snapshotFocus: "AI collaboration",
    snapshotFocusValue: "Read AI-generated code and judge whether the logic holds",
    tocTitle: "Contents",
  ...
  zh: {
    htmlLang: "zh-CN",
    metaDescription: "Dale Anfer 的个人技术博客名片，展示数学理解、数据直觉、AI 辅助代码理解和公开数据分析写作。",
    ...
    fitPanelKicker: "给招聘方",
    fitPanelTitle: "偏 HR、数据分析和产品运营方向的实习候选人",
    fitTargetLabel: "目标岗位",
    fitTargetValue: "HR 实习、数据分析、产品运营相关实习",
    fitEvidenceLabel: "作品证据",
    fitEvidenceValue: "数学理解、数据直觉、AI 辅助代码解读、可解释分析",
    fitGithubLabel: "GitHub",
    fitGithubValue: "github.com/sudoun",
    workEyebrow: "公开写作",
    workTitle: "能证明我如何思考的文章",
    workSubtitle: "主页聚焦已经审核的公开文章和数据分析笔记。",
    hrProjectKicker: "公开写作",
    hrProjectTitle: "数据分析文章",
    hrProjectSummary: "用公开技术文章展示数据审计、建模假设、图表解释和可复核结论。",
    hrFactModelLabel: "模型",
    hrFactModelValue: "非结构化招聘信息 → 字段抽取、权重评分、证据缺口和可解释决策",
    hrFactStackLabel: "技术",
    ...
    proofKicker: "能力信号",
    proofTitle: "我希望主页证明什么",
    proofSubtitle: "我希望招聘方看到：我不是只会操作工具，而是能理解模型、数据和输出背后的逻辑。",
    ...
    proofDecisionText: "我能把混乱的岗位、运营或业务信息转成可比较、可决策的结构。",
    snapshotRole: "数学直觉",
    snapshotRoleValue: "能把问题拆成变量、约束、假设和可解释结论",
    snapshotTools: "数据理解",
    snapshotToolsValue: "关注数据背后的结构、异常、口径和隐含信息",
    snapshotFocus: "AI 协作",
    snapshotFocusValue: "能解读 AI 生成代码，并判断其逻辑是否成立",
    tocTitle: "目录",
    keyTakeaways: "要点",
    shortNote: "短文",
    noPosts: "",
